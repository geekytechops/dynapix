<html>
    ...
    <head>
        <title>Theatres | Media | Dynapix</title>
        <meta charset="UTF-8">
       ...
       <header>
        ...
        <section class="breadcrumbs">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <a href="index.html">Home</a> > Theatres
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="selectbar">
                            <h1 class="title"><span class="headingbg">Theatres</span></h1>
                            <select>
                    ...
                    <div class="col-12">
                        <div class="mediawrap">
                            <a href="amb-cinemas.html" class="wrap">
                                <img src="images/category/img164.jpg">
                                <div class="content">
                                    <h2 class="title">AMB Cinemas</h2>
                                    <div class="stats">
                                        <div class="wrap"><i class="fas fa-map-pin"></i> Hyderabad</div>
                                        <div class="wrap"><i class="fas fa-display"></i> 8</div>
                                    </div>
                                </div>
                            </a>
                            <a href="aaa-cinemas.html" class="wrap">
                                <img src="images/category/img186.jpg">
                                <div class="content">
                                    <h2 class="title">AAA Cinemas</h2>
                                    <div class="stats">
                                        <div class="wrap"><i class="fas fa-map-pin"></i> Ameerpet</div>
                                        <div class="wrap"><i class="fas fa-display"></i> 24</div>
                                    </div>
                                </div>
                            </a>
                            <a href="jp-cinemas.html" class="wrap">
                                <img src="images/category/img227.jpg">
                                <div class="content">
                                    <h2 class="title">J.P. Cinemas</h2>
                                    <div class="stats">
                                        <div class="wrap"><i class="fas fa-map-pin"></i> Chandanagar</div>
                                        <div class="wrap"><i class="fas fa-display"></i> 14</div>
                                    </div>
                                </div>
                            </a>
                            <a href="miraj-cinemas.html" class="wrap">
                                <img src="images/category/img291.jpg">
                                <div class="content">
                                    <h2 class="title">Miraj Cinemas</h2>
                                    <div class="stats">
                                        <div class="wrap"><i class="fas fa-map-pin"></i> Hyderabad</div>
                                        <div class="wrap"><i class="fas fa-display"></i> 68</div>
                                    </div>
                                </div>
                            </a>
                            <a href="prasad-imax.html" class="wrap">
                                <img src="images/category/img266.jpg">
                                <div class="content">
                                    <h2 class="title">Prasad I-Max</h2>
                                    <div class="stats">
                                        <div class="wrap"><i class="fas fa-map-pin"></i> Hyderabad</div>
